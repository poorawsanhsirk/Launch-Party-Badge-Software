...
LP586X_I2C::LP586X_I2C(uint8_t enablePin, uint8_t ifsPin, uint8_t syncPin) {
...
int16_t LP586X_I2C::readRegister16bit(uint8_t regAddr10bit) {
    uint8_t regAddr8bit = regAddr10bit & 0xFF;
    int16_t value = 0;
    ...
    Wire.requestFrom(_currentSlaveAddr, (uint8_t)2);
