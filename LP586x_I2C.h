...
class LP586X_I2C {
    ...
    public:
         ...
         * @param ifsPin Arduino pin connected to interface select
         * @param syncPin Arduino pin connected to sync signal
         */
        LP586X_I2C(uint8_t enablePin, uint8_t ifsPin, uint8_t syncPin);
         ...
         */
        int16_t readRegister16bit(uint8_t regAddr10bit);
